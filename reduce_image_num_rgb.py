...
one_dir_r=r'..\rgbd_people_unihall.tar\rgbd_people_unihall\mensa_seq0_1.1\rgb_jpg_camera_one_reduce_num'
two_dir_r=r'..\rgbd_people_unihall.tar\rgbd_people_unihall\mensa_seq0_1.1\rgb_jpg_camera_two_reduce_num'
three_dir_r=r'..\rgbd_people_unihall.tar\rgbd_people_unihall\mensa_seq0_1.1\rgb_jpg_camera_three_reduce_num'
makedir(one_dir_r)
makedir(two_dir_r)
makedir(three_dir_r)
